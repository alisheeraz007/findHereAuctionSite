...
class Refregirators extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            index: 0,
...
export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(withRouter(Refregirators)));