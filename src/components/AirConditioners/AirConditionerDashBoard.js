...
class AirConditionerDashboard extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            index: 0,
                ...
                <main className={classes.content}>
                    ...
                    <Paper className={classes.mainBody}>
                        {Object.values(this.props.posts).map((item, index) => {
                            return (
                                item.category === "Air Conditioners" ?
...
export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(withRouter(AirConditionerDashboard)));